...
const postOrder = form =>
  axios.post('http://10.1.162.174:3000/api/v1/orders', form).then(res => res.data)

// 读取订单
const listOrders = (user_id, type, start, limit) =>
  axios
    .get(`http://10.1.162.174:3000/api/v1/user/${user_id}/orders`, {
...
const showOrder = order_id =>
  axios.get(`http://10.1.162.174:3000/api/v1/orders/${order_id}`).then(res => res.data)
